...
// Differenzkalkulation-Seite mit Formular und Ergebnis-Tabelle
function DifferencePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await calculate('difference', input);
      setResult(data);
    } catch (err) {
  ...
  return (
    <div>
      <h2 className="page-title">Differenzkalkulation</h2>
      <p className="page-description">
        Ermittle den Gewinn bei gegebenem Einkaufs- und Verkaufspreis.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-grid">
          <InputField label="Listeneinkaufspreis" name="listPurchasePrice" value={values.listPurchasePrice} onChange={handleChange} error={fieldErrors.listPurchasePrice} suffix="€" />
